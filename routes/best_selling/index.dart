...
Future<Response> _getResponse(RequestContext context) async {
  return switch (context.request.method) {
    HttpMethod.get => await _getBestSellingProducts(context),
    _ => ResponseHelper.methodNotAllowed(),
  };
}

Future<Response> _getBestSellingProducts(RequestContext context) async {
  try {
    final productsRepo = instance<ProductsRepository>();
    final products = await productsRepo.getBestSelling();
    if (products.isRight()) {
